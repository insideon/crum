...
export interface ApiAdvertisementAdvertisement extends Struct.SingleTypeSchema {
  ...
  attributes: {
    adDensity: Schema.Attribute.Enumeration<['low', 'medium', 'high']> &
      Schema.Attribute.DefaultTo<'medium'>;
    adsenseClientId: Schema.Attribute.String;
    adsenseEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    adsenseSlots: Schema.Attribute.JSON;
    coupangAccessKey: Schema.Attribute.String;
    coupangEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    coupangSecretKey: Schema.Attribute.String;
    coupangTrackingId: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    showAdOnMobile: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<true>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    sourceKeyword: Schema.Attribute.String;
    ...
    trendScore: Schema.Attribute.Decimal;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteConfigSiteConfig extends Struct.SingleTypeSchema {
  ...
  attributes: {
    articlesPerDay: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<8>;
    automationEnabled: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    defaultOgImage: Schema.Attribute.String;
    faviconUrl: Schema.Attribute.String;
    googleAnalyticsId: Schema.Attribute.String;
    googleSearchConsoleId: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    minTrendScore: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0.5>;
    publishedAt: Schema.Attribute.DateTime;
