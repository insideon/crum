...
function generateDummyProducts(keyword: string, limit: number): CoupangProduct[] {
  const dummyProducts: CoupangProduct[] = [
    ...
    },
    {
      ...
      productPrice: 45900,
      productImage: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=300&h=300&fit=crop',
    ...
    },
    {
      ...
      productPrice: 8900,
      productImage: 'https://images.unsplash.com/photo-1572635196237-14b3f281503f?w=300&h=300&fit=crop',
